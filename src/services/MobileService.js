...
class MobileService {
  constructor() {
    this.service = axios.create({
      baseURL: import.meta.env.VITE_API_ENDPOINT_MOBILE
    })
  ...
  getMobiles() {
    return this.service.get('/api/product')
  }

  getMobileDetail(id) {
    return this.service.get(`/api/product/${id}`)
  }
  ...
  */
  ...
  addToCart(data) {
    ...
    */
    return this.service.post(`/api/cart`, data)
  }
}
